...
void Unit::getUtilitystats()
{
    ...
    {
        std::cout << "water utility does NOT exist on unit " << unitNumber << ".\n";
    }
    ...
    {
        std::cout << "waste utility does NOT exist on unit " << unitNumber << ".\n";
    }
    ...
    {
        std::cout << "power utility does NOT exist on unit " << unitNumber << ".\n";
    }
}
